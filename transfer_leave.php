...
if ($_POST[leave_id] == '') {
    ...
    echo "<meta http-equiv='refresh' content='2;URL=detial_leave.php?id=$check_id' />";
}else{
for ($i = 0; $i < count($_POST[leave_id]); $i++) {
    if (trim($_POST[leave_id][$i]) != '') {
        ...
        $sql=  mysql_query("update timela set status='Y' where id='$id_l[$i]' and empno='$empno[$i]'");
}}
$Detial_name = mysql_query("select e1.depid as depno,concat(p1.pname,e1.firstname,' ',e1.lastname) as fullname,
...
$NameDetial = mysql_fetch_assoc($Detial_name);
?>
<div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb alert-success">
              ...
              <li><a href="detial_leave.php?id=$check_id'"><i class="fa fa-home"></i> รายละเอียดข้อมูลการลา</a></li>
