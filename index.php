...
<?php  $c++;$I++; } ?>
                        <tfoot>
                           <?php $sql_sum=  mysql_query("SELECT COUNT(p.empno) as b2,SUM(p.abode) as b4,
...
?>
    <div class="row">
        ...
        <div class="col-lg-2 col-xs-6" align="right">
            ...
            <a href="#" class="btn btn-success" onclick="window.open('<?= $folder_manual.$Manual?>','','width=820,height=1000'); return false;" title="คู่มือการใช้โปรแกรม">คู่มือการใช้งาน</a>
        </div>
         <p><br><br>
            <div class="col-lg-5">
                <div class="row">      
