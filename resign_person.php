...
<div class="row">
          <div class="col-lg-12">
              <h1><img src='images/identity-x.png' width='75'><font color='blue'>  ข้อมูลบุคลากรย้าย/ลาออก </font></h1> 
          ...
          <div class="col-lg-12">
              <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><img src='images/kuser.ico' width='25'> ตารางบุคลากรย้าย/ลาออก</h3>
                    </div>
                <div class="panel-body">
                    <form class="navbar-form navbar-right" name="frmSearch" role="search" method="post" action="resign_person.php">
