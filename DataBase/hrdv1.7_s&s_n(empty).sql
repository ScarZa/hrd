...
--
-- Host: localhost
-- Generation Time: Apr 05, 2016 at 05:00 PM
...
(1, 1, '2016-04-04 09:48:50', 'test cancle', 1, ''),
(2, 3, '2016-04-04 09:55:09', 'test cancle2', 1, '');

-- --------------------------------------------------------

--
-- Table structure for table `cneu`
--

CREATE TABLE IF NOT EXISTS `cneu` (
...
INSERT INTO `count` (`count_id`, `count_name`, `count`) VALUES
(1, 'regis_leave', 0000),
(2, 'regis_tleave', 0000),
(3, 'regis_conferance', 0000),
(4, 'regis_car', 0000);
...
('', 'กลุ่มงาน Excellence Center', '', 3, 33);
...
INSERT INTO `educate` (`ed_id`, `empno`, `educate`, `major`, `institute`, `enddate`, `start_date`, `check_ed`) VALUES
(1, 1, '5', 'วิทยาการคอมพิวเตอร์', 'มหาวิทยาลัยราชภัฎเลย', '2015-08-21', '0000-00-00', 1),
(2, 2, '4', 'test test ทดสอบ', 'test1 ทดสอบ', '2016-02-15', '0000-00-00', 1),
(3, 3, '5', 'วิทยาการคอมพิวเตอร์', 'มหาวิทยาลัยราชภัฎเลย', '2009-04-01', '0000-00-00', 1),
(4, 4, '6', 'test test ทดสอบ', 'test1 ทดสอบ', '2006-04-01', '0000-00-00', 1),
(5, 5, '5', 'บัญชี', 'ทดสอบ', '2016-04-04', '0000-00-00', 1);
...
(0001, '0001', '0123456789876', '1', 'ทดสอบ', 'ระบบบุคลากร', '1', '2014-04-02', '440 ม.4 ต.นาอาน', '', '4000', '446', '30', '42000', '1', '0001', '02', '4', '1', '042808121', '', '', '28', '4', '7', '', '2014-04-02', '0000-00-00', ''),
(0002, '0002', '0123456789875', '1', 'พนักงาน', 'ขับรถ', '1', '2016-02-15', '440 ม.4 ต.นาอาน', '', '4000', '446', '30', '42000', '1', '0002', '02', '4', '1', '', '', '', '23', '4', '40', '', '2016-02-15', '0000-00-00', ''),
(0003, '0003', '0123456789877', '1', 'หัวหน้าหน่วยงาน', 'ระบบบุคลากร', '1', '2016-04-04', '440 ม.4 ต.นาอาน', '', '4000', '446', '30', '42000', '1', '0003', '02', '3', '1', '', '', '', '28', '5', '39', '', '2009-04-01', '0000-00-00', ''),
(0004, '0004', '0123456789876', '1', 'หัวหน้าฝ่ายงาน', 'ระบบบุคลากร', '1', '2016-04-04', '440 ม.4 ต.นาอาน', '', '7022', '783', '56', '42000', '1', '0004', '02', '1', '1', '', '', '', '32', '5', '8', '', '2008-04-01', '0000-00-00', ''),
(0005, '0005', '0123456789876', '3', 'การเงิน', 'ระบบบุคลากร', '2', '2016-04-04', '440', '', '3999', '446', '30', '42000', '1', '0005', '02', '3', '1', '', '', '', '15', '5', '18', '', '2016-04-04', '0000-00-00', '');
...
INSERT INTO `hospital` (`hospital`, `name`, `manager`, `logo`, `url`) VALUES
(1, 'โรงพยาบาลจิตเวชเลยราชนครินทร์', '0001', NULL, 'http://localhost:808/');
...
(0001, '21232f297a57a5a743894a0e4a801fc3', '81dc9bdb52d04dc20036dbd8313ed055', 'admin', 0001, 'ADMIN', '2016-04-05', '16:52:16'),
(0002, '2254342becceafbd04538e0a38696791', '81dc9bdb52d04dc20036dbd8313ed055', 'dep', 0003, 'SUSER', '2016-04-04', '15:21:26'),
(0003, 'e6d96502596d7e7887b76646c5f615d9', '81dc9bdb52d04dc20036dbd8313ed055', 'car', 0002, 'USER', '2016-04-04', '12:17:38'),
(0004, '09eeb906353da00d12203a34c2af5db4', '81dc9bdb52d04dc20036dbd8313ed055', 'mdep', 0004, 'USUSER', '2016-04-04', '15:53:38');
...
--
-- Table structure for table `profressional_license`
--

CREATE TABLE IF NOT EXISTS `profressional_license` (
...
--
-- Dumping data for table `profressional_license`
--
...
--
-- Table structure for table `ss_car`
--

CREATE TABLE IF NOT EXISTS `ss_car` (
...
--
-- Table structure for table `ss_carlicense`
--

CREATE TABLE IF NOT EXISTS `ss_carlicense` (
...
--
-- Dumping data for table `ss_carlicense`
--

INSERT INTO `ss_carlicense` (`license_id`, `license_name`, `cartype_id`, `rider`, `oil_type`, `recive_date`, `car_status`) VALUES
(1, 'นข 373 เลย', 1, 1, 1, '2016-02-15', 1),
(2, 'บจ 7579 เลย', 3, 2, 1, NULL, 1),
(3, 'นข 1041 เลย', 0, 0, 0, NULL, 0),
(4, 'ฮย 6209 กทม', 0, 0, 0, NULL, 0),
(5, 'ฮม 5395 กทม', 0, 0, 0, NULL, 0);

-- --------------------------------------------------------

--
-- Table structure for table `ss_car_status`
--

CREATE TABLE IF NOT EXISTS `ss_car_status` (
...
--
-- Dumping data for table `ss_car_status`
--

INSERT INTO `ss_car_status` (`carstatus_id`, `carstatus_name`) VALUES
(1, 'ใช้งาน'),
(2, 'ซ่อมบำรุง'),
(3, 'จำหน่าย');
...
--
-- Table structure for table `ss_car_type`
--

CREATE TABLE IF NOT EXISTS `ss_car_type` (
...
--
-- Dumping data for table `ss_car_type`
--

INSERT INTO `ss_car_type` (`cartype_id`, `cartype_name`) VALUES
(1, 'รถฉุกเฉิน'),
(2, 'รถตู้'),
(3, 'รถกระบะ');
...
--
-- Table structure for table `ss_conferance`
--

CREATE TABLE IF NOT EXISTS `ss_conferance` (
...
--
-- Dumping data for table `ss_conferance`
--
...
--
-- Table structure for table `ss_detial_oil`
--

CREATE TABLE IF NOT EXISTS `ss_detial_oil` (
...
--
-- Dumping data for table `ss_detial_oil`
--
...
CREATE TABLE IF NOT EXISTS `ss_member` (
...
INSERT INTO `ss_member` (`ss_UserID`, `ss_Username`, `ss_Password`, `ss_user_name`, `ss_Name`, `ss_Status`, `ss_process`) VALUES
(1, '21232f297a57a5a743894a0e4a801fc3', '81dc9bdb52d04dc20036dbd8313ed055', 'admin', 1, 'ADMIN', 0);

-- --------------------------------------------------------

--
-- Table structure for table `ss_oil_type`
--

CREATE TABLE IF NOT EXISTS `ss_oil_type` (
...
--
-- Dumping data for table `ss_oil_type`
--

INSERT INTO `ss_oil_type` (`oil_id`, `oil_name`) VALUES
(1, 'ดีเซล'),
(2, 'เบนซิน');
...
--
-- Table structure for table `ss_room`
--
...
--
-- Dumping data for table `ss_room`
--

INSERT INTO `ss_room` (`room_id`, `room_name`) VALUES
(1, 'ห้องประชุมกองสุข(ห้องประชุมใหญ่)'),
(2, 'ห้องประชุมอุครานันท์(ห้องประชุมเล็ก)');
...
--
-- Table structure for table `train_nurse`
--

CREATE TABLE IF NOT EXISTS `train_nurse` (
...
--
-- Dumping data for table `train_nurse`
--

INSERT INTO `train_nurse` (`train_id`, `train_name`) VALUES
(1, 'การพยาบาลเฉพาะทางสุขภาพจิตและจิตเวชเด็กและวัยรุ่น'),
(2, 'การพยาบาลเฉพาะทางสุขภาพจิตและจิตเวชผู้ใหญ่'),
(3, 'การพยาบาลเฉพาะทางสุขภาพจิตและจิตเวชผู้สูงอายุ'),
(4, 'การพยาบาลเฉพาะทางสุขภาพจิตและจิตเวชผู้ติดยาเสพติด');
