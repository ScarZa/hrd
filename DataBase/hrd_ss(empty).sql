...
-- ----------------------------
-- Table structure for cneu
-- ----------------------------
DROP TABLE IF EXISTS `cneu`;
CREATE TABLE `cneu` (
  `cneu_id` int(7) NOT NULL AUTO_INCREMENT,
  `ed_id` int(7) DEFAULT NULL,
  `idpi` int(7) DEFAULT NULL,
  `tuid` int(7) DEFAULT NULL,
...
CREATE TABLE `comment` (
  ...
  `check_comm` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`comm_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `count` (
  `count_id` int(2) NOT NULL AUTO_INCREMENT,
  `count_name` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
...
-- Records of count
-- ----------------------------
INSERT INTO `count` VALUES ('1', 'regis_leave', '0000');
INSERT INTO `count` VALUES ('2', 'regis_tleave', '0000');
INSERT INTO `count` VALUES ('3', 'regis_conferance', '0000');
INSERT INTO `count` VALUES ('4', 'regis_car', '0000');
...
INSERT INTO `department` VALUES ('1103', 'งานห้องสมุด', '11', '1', '17');
INSERT INTO `department` VALUES ('1102', 'งานโสตทัศนศึกษา', '11', '1', '18');
...
-- Records of educate
-- ----------------------------
INSERT INTO `educate` VALUES ('1', '1', '5', 'วิทยาการคอมพิวเตอร์', 'มหาวิทยาลัยราชภัฎเลย', '2015-07-27', '0000-00-00', '1');
INSERT INTO `educate` VALUES ('2', '2', '4', 'ช่างอิเล็กทรอนิคส์', 'วิทยาลัยเทคนิคเลย', '2016-10-03', '0000-00-00', '1');
INSERT INTO `educate` VALUES ('3', '3', '4', 'ช่างยนต์', 'วิทยาลัยเทคนิคเลย', '2016-08-01', '0000-00-00', '1');
INSERT INTO `educate` VALUES ('4', '4', '5', 'ช่างอิเล็กทรอนิคส์', 'วิทยาลัยเทคนิคเลย', '2016-08-01', '0000-00-00', '1');
...
-- ----------------------------
-- Table structure for emppersonal
-- ----------------------------
...
-- ----------------------------
-- Records of emppersonal
-- ----------------------------
INSERT INTO `emppersonal` VALUES ('1', '0001', '0123456789876', '1', 'ผู้ดูแล', 'ระบบบุคลากร', '1', '2016-10-01', '440 ม.4 ต.นาอาน', '', '4000', '446', '30', '42000', '1', '0001', '02', '4', '1', '042808121', '0890277607', 'scarza@hotmail.com', '28', '5', '39', '', '2016-10-03', '0000-00-00', '');
INSERT INTO `emppersonal` VALUES ('2', '0002', '0123456789875', '1', 'ผู้ใช้งานทั่วไป', 'ระบบบุคลากร', '1', '2016-10-01', '440 ม.4 ต.นาอาน', '', '4000', '446', '30', '42000', '1', '0002', '02', '4', '1', '042808101', '', '', '28', '4', '7', '', '2016-10-03', '0000-00-00', '');
INSERT INTO `emppersonal` VALUES ('3', '0003', '0123456789874', '1', 'พนักงาน', 'ขับรถ', '1', '2016-09-01', '440 ม.4 ต.นาอาน', '', '4000', '446', '30', '42000', '1', '0003', '02', '4', '1', '042808102', '', '', '23', '4', '40', '', '2016-09-01', '0000-00-00', '');
INSERT INTO `emppersonal` VALUES ('4', '0004', '0123456789873', '1', 'เจ้าหน้าที่', 'โสต', '1', '2016-08-01', '440 ม.4 ต.นาอาน', '', '4000', '446', '30', '42000', '2', '0004', '02', '3', '1', '042808103', '', '', '18', '5', '13', '', '2016-08-01', '0000-00-00', '');
...
-- ----------------------------
-- Table structure for empstuc
-- ----------------------------
DROP TABLE IF EXISTS `empstuc`;
...
-- ----------------------------
-- Table structure for emstatus
-- ----------------------------
DROP TABLE IF EXISTS `emstatus`;
...
-- Records of emstatus
-- ----------------------------
INSERT INTO `emstatus` VALUES ('2', 'ย้าย');
INSERT INTO `emstatus` VALUES ('3', 'ลาออก');
INSERT INTO `emstatus` VALUES ('4', 'เสียชีวิต');
...
CREATE TABLE `fingerprint` (
  ...
  `work_scan` varchar(1) DEFAULT NULL,
  `finish_work_scan` varchar(1) DEFAULT NULL,
  `register` int(7) NOT NULL,
  `see` varchar(1) NOT NULL,
  `reason_forget` varchar(255) DEFAULT NULL,
  `explain_date` date DEFAULT NULL,
  `exponent` int(7) DEFAULT NULL,
  `explanation` varchar(255) DEFAULT NULL,
  `exp_status` varchar(1) NOT NULL,
  `editer` int(7) DEFAULT NULL,
...
-- Records of hospital
-- ----------------------------
INSERT INTO `hospital` VALUES ('1', 'โรงพยาบาลจิตเวชเลยราชนครินทร์', '0133', '09-07-20151logo.png', 'http://rploei.go.th/', 'โรงพยาบาลจิตเวชเลยฯ');
...
CREATE TABLE `late` (
  ...
  `register` int(7) NOT NULL,
  `see` varchar(1) NOT NULL,
  `reason_late` varchar(255) DEFAULT NULL,
  `explain_date` date DEFAULT NULL,
  `exponent` int(7) DEFAULT NULL,
  `explanation` varchar(255) DEFAULT NULL,
  `exp_status` varchar(1) NOT NULL,
...
-- Records of member
-- ----------------------------
INSERT INTO `member` VALUES ('0001', '21232f297a57a5a743894a0e4a801fc3', '81dc9bdb52d04dc20036dbd8313ed055', 'admin', '0001', 'ADMIN', '2016-11-20', '09:49:00');
INSERT INTO `member` VALUES ('0002', 'ee11cbb19052e40b07aac0ca060c23ee', '81dc9bdb52d04dc20036dbd8313ed055', 'user', '0002', 'USER', null, null);
...
-- ----------------------------
-- Table structure for plan_out
-- ----------------------------
DROP TABLE IF EXISTS `plan_out`;
CREATE TABLE `plan_out` (
  ...
  `join_amount` int(3) DEFAULT NULL,
  `complacency` int(3) DEFAULT NULL,
  `cneu` int(2) DEFAULT NULL,
  PRIMARY KEY (`id_plan`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `posid` (
  ...
  PRIMARY KEY (`posId`)
) ENGINE=MyISAM AUTO_INCREMENT=273 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `posid` VALUES ('3', 'เจ้าพนักงานธุรการชำนาญงาน', '201');
INSERT INTO `posid` VALUES ('4', 'เจ้าพนักงานเภสัชการชำนาญงาน', '103');
INSERT INTO `posid` VALUES ('5', 'เจ้าพนักงานเวชสถิติชำนาญงาน', '202');
INSERT INTO `posid` VALUES ('266', 'นักจิตวิทยา', '');
INSERT INTO `posid` VALUES ('7', 'เจ้าพนักงานเครื่องคอมพิวเตอร์', '205');
INSERT INTO `posid` VALUES ('8', 'เจ้าหน้าที่บริหารงานทั่วไป', '206');
INSERT INTO `posid` VALUES ('9', 'เจ้าหน้าที่บันทึกข้อมูล', '207');
INSERT INTO `posid` VALUES ('10', 'เจ้าพนักงานพัสดุ', '208');
INSERT INTO `posid` VALUES ('11', 'ช่างไฟฟ้าและอิเล็กทรอนิกส์', '209');
INSERT INTO `posid` VALUES ('267', 'นายแพทย์ชำนาญการพิเศษ', '');
...
INSERT INTO `posid` VALUES ('23', 'พนักงานช่วยเหลือคนไข้', '105');
INSERT INTO `posid` VALUES ('264', 'พนักงานช่วยเหลือคนไข้ ส1', '');
INSERT INTO `posid` VALUES ('265', 'ผู้ช่วยเหลือคนไข้', '');
INSERT INTO `posid` VALUES ('26', 'พนักงานทำความสะอาด', '211');
INSERT INTO `posid` VALUES ('27', 'พนักงานประจำตึก', '212');
INSERT INTO `posid` VALUES ('28', 'พนักงานการเงินและบัญชี ส  2', '213');
INSERT INTO `posid` VALUES ('29', 'พนักงานการเงินและบัญชี ส  3', '213');
INSERT INTO `posid` VALUES ('30', 'พนักงานพิมพ์', '214');
...
INSERT INTO `posid` VALUES ('37', 'ผู้ช่วยช่างทั่วไป', '215');
INSERT INTO `posid` VALUES ('38', 'พนักงานเกษตรพื้นฐาน', '216');
INSERT INTO `posid` VALUES ('39', 'นักวิชาการคอมพิวเตอร์', '216');
INSERT INTO `posid` VALUES ('40', 'พนักงานบริการ', '101');
INSERT INTO `posid` VALUES ('41', 'พนักงานประจำห้องยา', '101');
INSERT INTO `posid` VALUES ('43', 'พนักงานพัสดุ  ส 3', '201');
INSERT INTO `posid` VALUES ('258', 'เจ้าพนักงานเภสัชกรรม', '');
INSERT INTO `posid` VALUES ('259', 'นักวิชาการสาธารณสุข', '');
INSERT INTO `posid` VALUES ('260', 'พนักงานธุรการ', '');
INSERT INTO `posid` VALUES ('269', 'นักเทคนิคการแพทย์', '');
INSERT INTO `posid` VALUES ('262', 'พนักงานพัสดุ', '');
INSERT INTO `posid` VALUES ('263', 'พนักงานช่วยเหลือคนไข้ ส2', '');
INSERT INTO `posid` VALUES ('268', 'พนักงานช่วยเหลือคนไข้', '');
INSERT INTO `posid` VALUES ('270', 'นักวิเคราะห์นโยบายและแผน', '');
INSERT INTO `posid` VALUES ('271', 'นักวิชาการพัสดุ', '');

-- ----------------------------
-- Table structure for print_leave
-- ----------------------------
DROP TABLE IF EXISTS `print_leave`;
CREATE TABLE `print_leave` (
...
-- ----------------------------
-- Records of print_leave
-- ----------------------------

-- ----------------------------
-- Table structure for print_tleave
-- ----------------------------
DROP TABLE IF EXISTS `print_tleave`;
CREATE TABLE `print_tleave` (
...
-- ----------------------------
-- Records of print_tleave
-- ----------------------------

-- ----------------------------
-- Table structure for profressional_license
-- ----------------------------
DROP TABLE IF EXISTS `profressional_license`;
CREATE TABLE `profressional_license` (
  `pl_id` int(7) NOT NULL AUTO_INCREMENT,
  `pl_no` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `CNEU` int(2) DEFAULT NULL,
  `start_approve` date NOT NULL,
  `expire_date` date NOT NULL,
  `expire` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `renew` int(3) NOT NULL,
  `empno` int(7) NOT NULL,
  `pl_pics` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`pl_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of profressional_license
-- ----------------------------
...
-- ----------------------------
-- Table structure for regularity
-- ----------------------------
...
-- ----------------------------
-- Records of regularity
-- ----------------------------

-- ----------------------------
-- Table structure for re_comment
-- ----------------------------
...
CREATE TABLE `re_comment` (
  ...
  `check_recomm` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`recomm_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of re_comment
-- ----------------------------

-- ----------------------------
-- Table structure for se_borrow
-- ----------------------------
DROP TABLE IF EXISTS `se_borrow`;
CREATE TABLE `se_borrow` (
  `borrow_id` int(7) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of se_borrow
-- ----------------------------

-- ----------------------------
-- Table structure for se_borrow_order
-- ----------------------------
DROP TABLE IF EXISTS `se_borrow_order`;
CREATE TABLE `se_borrow_order` (
  `bo_id` int(7) NOT NULL AUTO_INCREMENT,
  `bo_date` date NOT NULL,
  `reg_date` date NOT NULL,
  `empno` int(7) NOT NULL,
  `dep_id` int(2) NOT NULL,
  `bo_no` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bo_status` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `po_id` int(7) DEFAULT NULL,
  PRIMARY KEY (`bo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of se_borrow_order
-- ----------------------------
...
CREATE TABLE `se_company` (
  ...
  `comp_tell` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `comp_mobile` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `comp_fax` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`comp_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
-- ----------------------------
INSERT INTO `se_material_type` VALUES ('1', 'วัสดุสำนักงาน');
INSERT INTO `se_material_type` VALUES ('2', 'วัสดุงานบ้านงานครัว');
INSERT INTO `se_material_type` VALUES ('3', 'วัสดุคอมพิวเตอร์');
INSERT INTO `se_material_type` VALUES ('4', 'วัสดุโฆษณาและเผยแพร่');
INSERT INTO `se_material_type` VALUES ('5', 'วัสดุเครื่องแต่งกาย');
INSERT INTO `se_material_type` VALUES ('6', 'วัสดุวิทยาศาสตร์และการแพทย์');
...
CREATE TABLE `se_pay` (
  ...
  `empno` int(7) NOT NULL,
  `pay_status` enum('B','W') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'W',
  PRIMARY KEY (`pay_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
-- ----------------------------
-- Table structure for se_pay_borrow
-- ----------------------------
DROP TABLE IF EXISTS `se_pay_borrow`;
CREATE TABLE `se_pay_borrow` (
  `pbo_id` int(7) NOT NULL AUTO_INCREMENT,
  `pbo_date` date NOT NULL,
  `reg_date` date NOT NULL,
  `bo_id` int(7) NOT NULL,
  `borrow_id` int(7) NOT NULL,
  `mate_id` int(7) NOT NULL,
  `amount` int(7) NOT NULL,
...
-- ----------------------------
-- Table structure for se_reference
-- ----------------------------
DROP TABLE IF EXISTS `se_reference`;
CREATE TABLE `se_reference` (
  `ref_id` int(7) NOT NULL AUTO_INCREMENT,
  `reference_no` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`ref_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of se_reference
-- ----------------------------
...
-- ----------------------------
-- Table structure for ss_car
-- ----------------------------
DROP TABLE IF EXISTS `ss_car`;
CREATE TABLE `ss_car` (
  `car_id` int(7) NOT NULL AUTO_INCREMENT,
  `car_no` varchar(9) COLLATE utf8_unicode_ci NOT NULL,
  `empno_request` int(7) NOT NULL,
  `place` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `amphur` int(2) NOT NULL,
  `province` int(2) NOT NULL,
  `obj` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `amount_date` int(2) DEFAULT NULL,
  `passenger` int(7) NOT NULL,
  `wait` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `license_plate` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `car_type` int(2) DEFAULT NULL,
  `rider` int(7) DEFAULT NULL,
  `other` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pay` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `payer` int(7) DEFAULT NULL,
  `paye_date` date DEFAULT NULL,
  `approve` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `approver` int(7) DEFAULT NULL,
  `approve_date` date DEFAULT NULL,
  `reason` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `befor_mile` int(6) DEFAULT NULL,
  `after_mile` int(6) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for ss_carlicense
-- ----------------------------
DROP TABLE IF EXISTS `ss_carlicense`;
CREATE TABLE `ss_carlicense` (
  `license_id` int(2) NOT NULL AUTO_INCREMENT,
  `license_name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `cartype_id` int(2) NOT NULL,
  `rider` int(7) NOT NULL,
  `oil_type` int(2) NOT NULL,
...
-- ----------------------------
-- Records of ss_carlicense
-- ----------------------------
INSERT INTO `ss_carlicense` VALUES ('1', 'นข 373 เลย', '1', '137', '1', '0000-00-00', '1');
INSERT INTO `ss_carlicense` VALUES ('2', 'บจ 7579 เลย', '3', '29', '1', '0000-00-00', '1');
INSERT INTO `ss_carlicense` VALUES ('3', 'นข 1041 เลย', '2', '137', '1', '0000-00-00', '2');
INSERT INTO `ss_carlicense` VALUES ('4', 'ฮย 6209 กทม', '2', '73', '1', '0000-00-00', '1');
INSERT INTO `ss_carlicense` VALUES ('5', 'ฮม 5395 กทม', '2', '107', '1', '0000-00-00', '1');
INSERT INTO `ss_carlicense` VALUES ('6', 'นข 965 สก', '1', '137', '1', '2016-05-27', '1');

-- ----------------------------
-- Table structure for ss_car_status
-- ----------------------------
DROP TABLE IF EXISTS `ss_car_status`;
CREATE TABLE `ss_car_status` (
  `carstatus_id` int(1) NOT NULL AUTO_INCREMENT,
  `carstatus_name` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`carstatus_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of ss_car_status
-- ----------------------------
INSERT INTO `ss_car_status` VALUES ('1', 'ใช้งาน');
INSERT INTO `ss_car_status` VALUES ('2', 'ซ่อมบำรุง');
INSERT INTO `ss_car_status` VALUES ('3', 'จำหน่าย');

-- ----------------------------
-- Table structure for ss_car_type
-- ----------------------------
DROP TABLE IF EXISTS `ss_car_type`;
CREATE TABLE `ss_car_type` (
  `cartype_id` int(2) NOT NULL AUTO_INCREMENT,
  `cartype_name` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`cartype_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of ss_car_type
-- ----------------------------
INSERT INTO `ss_car_type` VALUES ('1', 'รถฉุกเฉิน');
INSERT INTO `ss_car_type` VALUES ('2', 'รถตู้');
INSERT INTO `ss_car_type` VALUES ('3', 'รถกระบะ');

-- ----------------------------
-- Table structure for ss_conferance
-- ----------------------------
DROP TABLE IF EXISTS `ss_conferance`;
CREATE TABLE `ss_conferance` (
  `conf_id` int(7) NOT NULL AUTO_INCREMENT,
  `conferance_no` varchar(9) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `empno_request` int(7) NOT NULL,
  `obj` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `start_date` date NOT NULL,
  ...
  `end_time` time NOT NULL,
  `amount` int(3) NOT NULL,
  `equip` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `audio` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `mic_table` int(2) DEFAULT NULL,
  `mic_wireless` int(2) DEFAULT NULL,
  `mic_line` int(2) DEFAULT NULL,
  `visualizer` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `projector` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `comp` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `format` int(1) NOT NULL,
  `room` int(1) NOT NULL,
  `approve` varchar(2) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `approver` int(7) DEFAULT NULL,
  PRIMARY KEY (`conf_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of ss_conferance
-- ----------------------------

-- ----------------------------
-- Table structure for ss_detial_oil
-- ----------------------------
DROP TABLE IF EXISTS `ss_detial_oil`;
CREATE TABLE `ss_detial_oil` (
  `do_id` int(7) NOT NULL AUTO_INCREMENT,
  `empno_report` int(7) NOT NULL,
  `license_id` int(2) NOT NULL,
  `reg_date` date NOT NULL,
  `pass_mile` int(6) NOT NULL,
  `this_mile` int(6) NOT NULL,
  ...
  `oil_type` int(1) NOT NULL,
  PRIMARY KEY (`do_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of ss_detial_oil
-- ----------------------------
...
CREATE TABLE `ss_member` (
  `ss_UserID` int(7) NOT NULL AUTO_INCREMENT,
  `ss_Username` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ss_Password` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ss_user_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ss_Name` int(7) NOT NULL,
  `ss_Status` enum('ADMIN','SUSER','NUSER') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ss_process` int(2) DEFAULT NULL,
  PRIMARY KEY (`ss_UserID`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of ss_member
-- ----------------------------
INSERT INTO `ss_member` VALUES ('1', '21232f297a57a5a743894a0e4a801fc3', '81dc9bdb52d04dc20036dbd8313ed055', 'admin', '1', 'ADMIN', '0');
INSERT INTO `ss_member` VALUES ('2', 'e6d96502596d7e7887b76646c5f615d9', '81dc9bdb52d04dc20036dbd8313ed055', 'car', '3', 'SUSER', '3');
INSERT INTO `ss_member` VALUES ('3', '3a8e4c06e471595f6eb262bb9b5582d9', '81dc9bdb52d04dc20036dbd8313ed055', 'conf', '4', 'SUSER', '2');

-- ----------------------------
-- Table structure for ss_oil_type
-- ----------------------------
DROP TABLE IF EXISTS `ss_oil_type`;
CREATE TABLE `ss_oil_type` (
  `oil_id` int(1) NOT NULL AUTO_INCREMENT,
  `oil_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`oil_id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of ss_oil_type
-- ----------------------------
INSERT INTO `ss_oil_type` VALUES ('1', 'ดีเซล');
INSERT INTO `ss_oil_type` VALUES ('2', 'เบนซิน');
...
CREATE TABLE `ss_room` (
  ...
  `room_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`room_id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
-- Records of ss_room
-- ----------------------------
INSERT INTO `ss_room` VALUES ('1', 'ห้องประชุมกองสุข( ห้องประชุมใหญ่ ) ');
INSERT INTO `ss_room` VALUES ('2', 'ห้องประชุมอุครานันท์( ห้องประชุมเล็ก )');

-- ----------------------------
-- Table structure for statusla
-- ----------------------------
DROP TABLE IF EXISTS `statusla`;
...
-- ----------------------------
-- Table structure for timela
-- ----------------------------
DROP TABLE IF EXISTS `timela`;
CREATE TABLE `timela` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for trainingin
-- ----------------------------
DROP TABLE IF EXISTS `trainingin`;
...
-- ----------------------------
-- Records of trainingin
-- ----------------------------

-- ----------------------------
-- Table structure for traininglevel
-- ----------------------------
...
INSERT INTO `trainingmoney` VALUES ('3', 'อื่นๆ');

-- ----------------------------
-- Table structure for trainingtype
-- ----------------------------
...
-- ----------------------------
-- Records of trainingtype
-- ----------------------------
INSERT INTO `trainingtype` VALUES ('1', 'ประชุม');
INSERT INTO `trainingtype` VALUES ('2', 'ประชุมเชิงปฏิบัติการ');
INSERT INTO `trainingtype` VALUES ('3', 'วิทยากร');
INSERT INTO `trainingtype` VALUES ('4', 'ศึกษาดูงาน');
INSERT INTO `trainingtype` VALUES ('5', 'สัมมนา');
INSERT INTO `trainingtype` VALUES ('6', 'อบรม');
INSERT INTO `trainingtype` VALUES ('7', 'อบรมเชิงปฏิบัติการ');
INSERT INTO `trainingtype` VALUES ('8', 'อื่นๆ');

-- ----------------------------
-- Table structure for training_out
-- ----------------------------
DROP TABLE IF EXISTS `training_out`;
CREATE TABLE `training_out` (
  `tuid` int(5) NOT NULL AUTO_INCREMENT,
  `empno` int(4) unsigned zerofill NOT NULL,
  `datein` date NOT NULL,
  `memberbook` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `Hos_car` varchar(2) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`tuid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- ----------------------------
-- Records of training_out
-- ----------------------------

-- ----------------------------
-- Table structure for train_nurse
-- ----------------------------
DROP TABLE IF EXISTS `train_nurse`;
CREATE TABLE `train_nurse` (
  `train_id` int(7) NOT NULL AUTO_INCREMENT,
  `train_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`train_id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of train_nurse
-- ----------------------------
INSERT INTO `train_nurse` VALUES ('1', 'การพยาบาลเฉพาะทางสุขภาพจิตและจิตเวชเด็กและวัยรุ่น');
INSERT INTO `train_nurse` VALUES ('2', 'การพยาบาลเฉพาะทางสุขภาพจิตและจิตเวชผู้ใหญ่');
INSERT INTO `train_nurse` VALUES ('3', 'การพยาบาลเฉพาะทางสุขภาพจิตและจิตเวชผู้สูงอายุ');
INSERT INTO `train_nurse` VALUES ('4', 'การพยาบาลเฉพาะทางสุขภาพจิตและจิตเวชผู้ติดยาเสพติด');

-- ----------------------------
-- Table structure for typevacation
-- ----------------------------
...
CREATE TABLE `work` (
  ...
  `reg_date` date NOT NULL,
  `leave_no` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `statusla` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `pics` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `depId` int(7) NOT NULL,
  `regis_leave` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `work_history` VALUES ('1', '1', '0001', '2016-10-03', '39', null, '28', '02', '4', '5');
INSERT INTO `work_history` VALUES ('2', '2', '0002', '2016-10-03', '7', null, '28', '02', '4', '4');
INSERT INTO `work_history` VALUES ('3', '3', '0003', '2016-09-01', '40', null, '23', '02', '4', '4');
INSERT INTO `work_history` VALUES ('4', '4', '0004', '2016-08-01', '13', null, '18', '02', '3', '5');
