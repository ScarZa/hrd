...
<h3>โรงพยาบาลนาโพธิ์ ของปี พ.ศ. <? echo $ryear+543;?></h3>
<?php
    ...
    $strXML = "<graph caption='จำนวนผู้ป่วย แยกตามรายเดือน' subCaption='' pieSliceDepth='30' showBorder='1' formatNumberScale='0' numberSuffix=' คน' animation=' " . $animateChart . "'>";
 ...
 //   $result = mysql_query($strQuery) or die(mysql_error());
  ...
  if ($result2) {
        while($ors2 = mysql_fetch_array($result2)) {
            $strXML .= "<set label='" . $ors['vstdate'] . "' value='" . $ors2['count_hn'] . "' />";
        }
    }
    mysql_close($link);
    ...
    echo renderChart("../../FusionCharts/FCF_Column2D.swf", "", $strXML, "FactorySum", 820, 360, false, false);
?>
<BR><BR>
</CENTER>
</BODY>
