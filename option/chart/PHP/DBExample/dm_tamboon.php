...
<br>
<CENTER>
<h2>จำนวนผู้ป่วยเบาหวานมารับบริการ ช่วงวันที่ <?php echo  Thaidate($d);?>   ถึง <?php echo  ThaiDate($d1);?></h2>
...
WHERE pt.chwpart='$jw' AND pt.amppart='$amp'  and (vn.pdx in($dmm) or vn.dx0 in($dmm) or vn.dx1 in($dmm) or vn.dx2 in($dmm) or vn.dx3 in($dmm) or vn.dx4 in($dmm) or vn.dx5 in($dmm)) AND vn.vstdate between '$d' and '$d1'
GROUP BY pt.tmbpart
