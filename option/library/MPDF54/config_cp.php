...
function GetLangOpts($llcc, $adobeCJK) {
	...
	//	else { $unifonts = ""; }
	  ...
	  // VIETNAMESE
	  CASE "vi":  
		$unifonts = "dejavusanscondensed,dejavusanscondensedB,dejavusanscondensedI,dejavusanscondensedBI,dejavusans,dejavusansB,dejavusansI,dejavusansBI,THSaraban,THSarabanI,THSarabanB,THSarabanBI"; break;
