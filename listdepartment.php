...
if($_POST[method]=='search_department'){
...
?>  
				    ...
				    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a href='./prcdepartment.php?method=mdelete&mdep_id=<?=$result[main_dep]?>'  title="confirm" onclick="if(confirm('ยืนยันการลบ <?php  echo  $result[name]; ?>&nbsp;ออกจากรายการ ')) return true; else return false;">   
					<i class="fa fa-trash-o"></i></a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a href='./prcdepartment.php?method=delete&dep_id=<?=$result[depId]?>'  title="confirm" onclick="if(confirm('ยืนยันการลบ <?php  echo  $result[name]; ?>&nbsp;ออกจากรายการ ')) return true; else return false;">   
					<i class="fa fa-trash-o"></i></a>
